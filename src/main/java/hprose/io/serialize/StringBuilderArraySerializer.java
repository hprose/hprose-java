...
final class StringBuilderArraySerializer implements HproseSerializer<StringBuilder[]> {
    ...
    public final static void write(OutputStream stream, WriterRefer refer, StringBuilder[] array) throws IOException {
    ...
    public final void write(HproseWriterImpl writer, StringBuilder[] obj) throws IOException {
