...
final class BigIntegerArrayUnserializer implements HproseUnserializer {
    ...
    public final static HproseUnserializer instance = new BigIntegerArrayUnserializer();

    public final Object read(HproseReader reader, ByteBuffer buffer, Class<?> cls, Type type) throws IOException {
        return reader.readBigIntegerArray(buffer);
    }

    public final Object read(HproseReader reader, InputStream stream, Class<?> cls, Type type) throws IOException {
        return reader.readBigIntegerArray(stream);
    }
