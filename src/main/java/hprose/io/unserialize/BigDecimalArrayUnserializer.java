...
final class BigDecimalArrayUnserializer implements Unserializer {
    ...
    final static BigDecimal[] read(Reader reader, ByteBuffer buffer) throws IOException {
        ...
        switch (tag) {
            ...
            case TagRef: return (BigDecimal[])reader.readRef(buffer);
    ...
    final static BigDecimal[] read(Reader reader, InputStream stream) throws IOException {
        ...
        switch (tag) {
            ...
            case TagRef: return (BigDecimal[])reader.readRef(stream);
            default: throw ValueReader.castError(reader.tagToString(tag), Array.class);
        }
    }
